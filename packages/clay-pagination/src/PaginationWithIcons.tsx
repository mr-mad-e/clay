...
export const PaginationWithIcons = React.forwardRef(
	function PaginationWithIcons(
		{
			active,
			activePage,
			alignmentPosition,
		...
		return (
			<Pagination {...otherProps} ref={ref}>
				...
				>
					<ClayIcon spritemap={spritemap} symbol="angle-double-left" />
				</Pagination.Item>
				...
				>
					<ClayIcon spritemap={spritemap} symbol="angle-double-right" />
				</Pagination.Item>
			</Pagination>
		);
	}
...
PaginationWithIcons.displayName = 'PaginationWithIcons';
